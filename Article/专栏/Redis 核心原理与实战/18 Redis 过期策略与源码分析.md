...
<meta content="18 Redis 过期策略与源码分析" name="description"/>
...
<h1 class="title" data-id="18 Redis 过期策略与源码分析" id="title">18 Redis 过期策略与源码分析</h1>
<div><p>在 Redis 中我们可以给一些元素设置过期时间，那当它过期之后 Redis 是如何处理这些过期键呢？</p>
<h3 id="过期键执行流程">过期键执行流程</h3>
<p>Redis 之所以能知道那些键值过期，是因为在 Redis 中维护了一个字典，存储了所有设置了过期时间的键值，我们称之为过期字典。</p>
<p>过期键判断流程如下图所示：</p>
<p><img alt="内存过期策略-过期键判断流程.png" src="assets/3bf71ae0-5de7-11ea-9e57-957b6467a3fc"/></p>
...
<p>过期键数据结构如下图所示：</p>
<p><img alt="微信截图_20191116185218.png" src="assets/4f62e050-5de7-11ea-97d6-db1217470ff3"/></p>
<h3 id="过期策略">过期策略</h3>
...
<p>惰性删除执行流程，如下图所示：</p>
<p><img alt="内存过期策略-惰性删除执行流程.png" src="assets/a5e135d0-5de7-11ea-8972-8fbbcd885f6f"/></p>
...
<p>定期删除执行流程，如下图所示：</p>
<p><img alt="内存过期策略-执行流程2.png" src="assets/c511d450-5de7-11ea-a9fa-c1c510366b3a"/></p>
<ul>
