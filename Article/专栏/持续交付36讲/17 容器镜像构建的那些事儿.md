...
<ol>
<li><p>Docker Out Of Docker（DooD）</p></li>
<li><p>Docker In Docker（DinD）</p></li>
</ol>
...
<h2 id="思考题">思考题</h2>
<ol>
<li><p>除了上述的 DooD 和 DinD 之外，你还知道哪些其他的Docker构建方案吗？它们分别有什么特点？</p></li>
<li><p>Docker构建的缓存机制的基本规则是怎样的，如果ADD或COPY命令后是不同的文件，缓存机制会怎么处理？</p></li>
</ol>
<p>欢迎你给我留言。-</p>
</div>
</div>
