...
<meta content="03  数据分片：如何存储超大规模的数据？" name="description"/>
...
<h1 class="title" data-id="03  数据分片：如何存储超大规模的数据？" id="title">03  数据分片：如何存储超大规模的数据？</h1>
<div><p>前两讲我们介绍了分布式数据库，以及各种 SQL 的发展脉络，那么从这一讲开始，我们就正式进入分布式数据库核心原理的学习。</p>
...
<p><img alt="Drawing 0.png" src="assets/CgpVE2ABUUmAL3H4AAGTDb7sQOQ568.png"/></p>
<p>图 1 可视化直观视图</p>
...
<p><img alt="Drawing 1.png" src="assets/Cip5yGABUVOANTI_AACPCvFkQMQ491.png"/></p>
<p>图 2 哈希分片</p>
<h4 id="范围分片">范围分片</h4>
<p>范围分片根据数据值或键空间的范围对数据进行划分，相邻的分片键更有可能落入相同的分片上。每行数据不像哈希分片那样需要进行转换，实际上它们只是简单地被分类到不同的分片上。下图是范围分片的工作原理。</p>
<p><img alt="Drawing 2.png" src="assets/Cip5yGABUXSATworAABCLehE-pM870.png"/></p>
<p>图 3 范围分片</p>
...
<h3 id="手动分片-vs-自动分片">手动分片 vs 自动分片</h3>
...
<p><img alt="Drawing 3.png" src="assets/Cip5yGABUWmAW6olAAECEkYbH8U406.png"/></p>
<p>图 4 分片键结构</p>
<p>其中有效部分有三个。</p>
<ol>
...
<p><img alt="Drawing 4.png" src="assets/CgqCHmABUYSAb4GHAAQVlwbl-X4314.png"/></p>
<p>图 5 自动分片功能展示</p>
<p>自动分片包含下图所示的四个过程。</p>
<p><img alt="Drawing 5.png" src="assets/Ciqc1GABUY2ACpn4AAM1n2uEO-A067.png"/></p>
<p>图 6 自动分片过程</p>
...
<h3 id="垂直与水平分片融合案例">垂直与水平分片融合案例</h3>
<p>TiDB 就是一个垂直与水平分片融合的典型案例，同时该方案也是 HATP 融合方案。</p>
<p>其中水平扩展依赖于底层的 TiKV，如下图所示。</p>
<p><img alt="Drawing 6.png" src="assets/Ciqc1GABUZWAF6UYAACmuUoCK3Y948.png"/></p>
<p>图 7 TiKV</p>
...
<p><img alt="Drawing 7.png" src="assets/Ciqc1GABUZ-AAH-KAAJGbLaxtiI142.png"/></p>
<p>图 8 TiFlash</p>
