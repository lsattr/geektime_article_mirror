...
<p>我们可以发现区块头部分的数据被存储到tb_block表中，然后交易哈希被存储的tb_tx表中，接着交易的输入输出被存储到tb_input和tb_output中，这三者是通过区块高度、交易哈希被链接起来的。</p>
<pre><code> tb_block &lt;--区块高度--&gt;  tb_tx &lt;--交易哈希--&gt; tb_input/tb_output
</code></pre>
<p>完整的Python脚本可以通过这个链接查看：</p>
<p><a href="https://github.com/mvs-org/mvsd-mysql-sync/blob/master/tools/sync.py" target="_blank">https://github.com/mvs-org/mvsd-mysql-sync/blob/master/tools/sync.py</a></p>
...
<p><img alt="" src="assets/9096deb3a0f542d897bf2c5526444d4e.jpg"/></p>
