...
<h3 id="镜像构建对比">镜像构建对比</h3>
<p>使用多阶段构建前后的代码我都已经放在了<a href="https://github.com/wilhelmguo/multi-stage-demo" target="_blank">Github</a>，你只需要克隆代码到本地即可。</p>
...
<h3 id="多阶段构建的其他使用方式">多阶段构建的其他使用方式</h3>
<p>多阶段构建除了我们上面讲解的使用方式，还有更多其他的使用方式，这些使用方式，可以使得多阶段构建实现更多的功能。</p>
<h4 id="为构建阶段命名">为构建阶段命名</h4>
...
<h4 id="停止在特定的构建阶段">停止在特定的构建阶段</h4>
...
<h4 id="使用现有镜像作为构建阶段">使用现有镜像作为构建阶段</h4>
