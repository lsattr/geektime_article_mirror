...
<meta content="06  最佳实践：如何在生产中编写最优 Dockerfile？" name="description"/>
...
<h1 class="title" data-id="06  最佳实践：如何在生产中编写最优 Dockerfile？" id="title">06  最佳实践：如何在生产中编写最优 Dockerfile？</h1>
...
<h4 id="6-尽量使用构建缓存">（6）尽量使用构建缓存</h4>
...
<h4 id="8-使用国内软件源加快镜像构建速度">（8）使用国内软件源加快镜像构建速度</h4>
