...
<meta content="37  集群容错：一个好汉三个帮（上）" name="description"/>
<link href="/static/favicon.png" rel="icon"/>
<title>37  集群容错：一个好汉三个帮（上） </title>
...
<h1 class="title" data-id="37  集群容错：一个好汉三个帮（上）" id="title">37  集群容错：一个好汉三个帮（上）</h1>
<div><p>你好，我是杨四正，今天我和你分享的主题是集群容错：一个好汉三个帮（上篇）。</p>
...
<h3 id="cluster-接口与容错机制">Cluster 接口与容错机制</h3>
...
<p><img alt="Lark20201201-164714.png" src="assets/Ciqc1F_GAzqAFfi0AAEr0jR4WUk707.png"/></p>
<p>Cluster 核心流程图</p>
...
<p><img alt="Lark20201201-164718.png" src="assets/Ciqc1F_GA0WADFvhAAFaDfyWGXU780.png"/></p>
<p>Cluster 接口继承关系</p>
<p><strong>在每个 Cluster 接口实现中，都会创建对应的 Invoker 对象，这些都继承自 AbstractClusterInvoker 抽象类</strong>，如下图所示：</p>
<p><img alt="Lark20201201-164728.png" src="assets/CgqCHl_GA0-AcVvrAAGLJ3YaO2Q177.png"/></p>
...
<h3 id="abstractclusterinvoker">AbstractClusterInvoker</h3>
...
<h3 id="abstractcluster">AbstractCluster</h3>
...
<p><img alt="Lark20201201-164721.png" src="assets/CgqCHl_GA2GAYY4rAAGXJIXwK1k980.png"/></p>
