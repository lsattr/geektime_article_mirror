...
<meta content="09 Java线程（上）：Java线程的生命周期" name="description"/>
...
<h1 class="title" data-id="09 Java线程（上）：Java线程的生命周期" id="title">09 Java线程（上）：Java线程的生命周期</h1>
<div><p>在Java领域，实现并发程序的主要手段就是多线程。线程是操作系统里的一个概念，虽然各种不同的开发语言如Java、C#等都对其进行了封装，但是万变不离操作系统。Java语言里的线程本质上就是操作系统的线程，它们是一一对应的。</p>
...
<p><img alt="" src="assets/9bbc6fa7fb4d631484aa953626cf6ae5.png"/></p>
<p>通用线程状态转换图——五态模型</p>
...
<h2 id="java中线程的生命周期">Java中线程的生命周期</h2>
...
<p><img alt="" src="assets/3f6c6bf95a6e8627bdf3cb621bbb7f8c.png"/></p>
<p>Java中的线程状态转换图</p>
...
<h3 id="1-runnable与blocked的状态转换">1. RUNNABLE与BLOCKED的状态转换</h3>
...
<h3 id="2-runnable与waiting的状态转换">2. RUNNABLE与WAITING的状态转换</h3>
...
<h3 id="3-runnable与timed-waiting的状态转换">3. RUNNABLE与TIMED_WAITING的状态转换</h3>
<p>有五种场景会触发这种转换：</p>
<ol>
...
<h3 id="4-从new到runnable状态">4. 从NEW到RUNNABLE状态</h3>
...
<h3 id="5-从runnable到terminated状态">5. 从RUNNABLE到TERMINATED状态</h3>
...
<p><img alt="" src="assets/67734e1a062adc7cf7baac7d6c17ddbe.png"/></p>
<p>发生死锁的线程栈</p>
<h2 id="课后思考">课后思考</h2>
