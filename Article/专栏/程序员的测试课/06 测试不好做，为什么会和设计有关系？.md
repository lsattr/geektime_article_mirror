...
<pre><code>public class TodoItemService {
...
<pre><code>interface TodoItemRepository {
  ...
}
...
<pre><code>class DbTodoItemRepository implements TodoItemRepository {
  ...
}
</code></pre>
<p>而要存到云存储，就写一个云存储的实现。</p>
<pre><code>class S3TodoItemRepository implements TodoItemRepository {
  ...
}
</code></pre>
...
<pre><code>@CommandLine.Command(name = "add")
...
<pre><code>this.service.addTodoItem(TodoParameter.of(item));
</code></pre>
