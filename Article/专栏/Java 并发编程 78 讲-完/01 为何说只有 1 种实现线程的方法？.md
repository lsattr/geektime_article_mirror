...
<meta content="01 为何说只有 1 种实现线程的方法？" name="description"/>
...
<h1 class="title" data-id="01 为何说只有 1 种实现线程的方法？" id="title">01 为何说只有 1 种实现线程的方法？</h1>
<div><p>在本课时我们主要学习为什么说本质上只有一种实现线程的方式？实现 Runnable 接口究竟比继承 Thread 类实现线程好在哪里？</p>
...
<h3 id="实现线程只有一种方式">实现线程只有一种方式</h3>
...
<h3 id="实现-runnable-接口比继承-thread-类实现线程要好">实现 Runnable 接口比继承 Thread 类实现线程要好</h3>
