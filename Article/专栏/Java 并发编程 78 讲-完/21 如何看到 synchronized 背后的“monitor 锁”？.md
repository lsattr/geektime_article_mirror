...
<meta content="21 如何看到 synchronized 背后的“monitor 锁”？" name="description"/>
...
<h1 class="title" data-id="21 如何看到 synchronized 背后的“monitor 锁”？" id="title">21 如何看到 synchronized 背后的“monitor 锁”？</h1>
<div><p>本课时我们研究下 synchronized 背后的 monitor 锁。</p>
<h3 id="获取和释放-monitor-锁的时机">获取和释放 monitor 锁的时机</h3>
...
<h3 id="用-javap-命令查看反汇编的结果">用 javap 命令查看反汇编的结果</h3>
