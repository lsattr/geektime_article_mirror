...
<meta content="12 从0到1：你的第一个GUI自动化测试" name="description"/>
...
<h1 class="title" data-id="12 从0到1：你的第一个GUI自动化测试" id="title">12 从0到1：你的第一个GUI自动化测试</h1>
...
<p><img alt="" src="assets/838b15ae28b8e318577705f61d619aa3.png"/></p>
<p>图1 在POM文件中加入Selenium 2.0的依赖</p>
<p>接着用Java创建一个main方法，并把如图2所示的代码复制到你的main方法中。</p>
<p><img alt="" src="assets/d4c851bf536ce1fa6167afa169ab8bfb.png"/></p>
...
<p>但是因为”同源政策（Same-origin policy）”（只有来自相同域名、端口和协议的JavaScript代码才能被浏览器执行），所以要想在测试用例运行中的浏览器中，注入JavaScript代码从而实现自动化的Web操作，Selenium RC就必须“欺骗”被测站点，让它误以为被注入的代码是同源的。</p>
...
<p><img alt="" src="assets/30bb6d776cd499b727d83fa4499ca9b6.png"/></p>
...
<p><img alt="" src="assets/9c8317d792a8798b3f2cdedf80ff2e69.png"/></p>
...
<p><img alt="" src="assets/5536bccaa266329c324fa9033ee16826.png"/></p>
