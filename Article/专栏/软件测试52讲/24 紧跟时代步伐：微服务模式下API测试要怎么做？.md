...
<meta content="24 紧跟时代步伐：微服务模式下API测试要怎么做？" name="description"/>
<link href="/static/favicon.png" rel="icon"/>
<title>24 紧跟时代步伐：微服务模式下API测试要怎么做？ </title>
...
<h1 class="title" data-id="24 紧跟时代步伐：微服务模式下API测试要怎么做？" id="title">24 紧跟时代步伐：微服务模式下API测试要怎么做？</h1>
<div><p>你好，我是茹炳晟，今天我分享的主题是“紧跟时代步伐：微服务模式下API测试要怎么做？”。</p>
...
<h2 id="单体架构-monolithic-architecture">单体架构（Monolithic Architecture）</h2>
<p>单体架构是早期的架构模式，并且存在了很长时间。单体架构是将所有的业务场景的表示层、业务逻辑层和数据访问层放在同一个工程中，最终经过编译、打包，并部署在服务器上。</p>
...
<h2 id="微服务架构-microservice-architecture">微服务架构（Microservice Architecture）</h2>
...
<p><img alt="" src="assets/6968c125be2de960b48d8df35315159d.png"/></p>
<p>图1 单体架构 VS 微服务架构</p>
<p>微服务架构具有以下特点：</p>
<ul>
...
<p><img alt="" src="assets/ab5e06ccd5d4e3925fe86024b54162e2.png"/></p>
<p>图2 基于代码覆盖率指导测试用例设计的示例</p>
...
<p><img alt="" src="assets/79f5990fd864012cb1c7cd87c8e5079b.png"/></p>
<p>图3 API之间的耦合示例</p>
...
<h2 id="基于消费者契约的api测试">基于消费者契约的API测试</h2>
...
<p><img alt="" src="assets/4b60dcc958636c29ae8edd5e52db216f.png"/></p>
<p>图4 Service A、Service B和Service T的关系</p>
...
<p><img alt="" src="assets/1e9c9cb78a02e3675e612da46e2c1b86.png"/></p>
<p>图5 收集消费者契约的逻辑原理</p>
...
<h2 id="微服务测试的依赖解耦和mock-service">微服务测试的依赖解耦和Mock Service</h2>
...
<p><img alt="" src="assets/e18bf590c818e5dc26e85a5e07eb1401.png"/></p>
<p>图6 基于Mock Service解决API之间的调用依赖</p>
<h2 id="代码实例">代码实例</h2>
...
<p>具体的实例代码，你可以从<a href="https://github.com/SpectoLabs/spring-cloud-contract-blog" target="_blank">https://github.com/SpectoLabs/spring-cloud-contract-blog</a>下载，详细的代码解读可以参考<a href="https://specto.io/blog/2016/11/16/spring-cloud-contract/" target="_blank">https://specto.io/blog/2016/11/16/spring-cloud-contract/</a>。</p>
...
<p>这个实例的逻辑关系如图7所示。</p>
<p><img alt="" src="assets/db1b2b058505fef62805f9077e1982fa.png"/></p>
<p>图7 基于Spring Cloud Contract的契约测试实例</p>
<h2 id="总结">总结</h2>
