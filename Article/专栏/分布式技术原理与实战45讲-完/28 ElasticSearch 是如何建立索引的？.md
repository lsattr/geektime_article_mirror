...
<meta content="28 ElasticSearch 是如何建立索引的？" name="description"/>
<link href="/static/favicon.png" rel="icon"/>
<title>28 ElasticSearch 是如何建立索引的？ </title>
...
<h1 class="title" data-id="28 ElasticSearch 是如何建立索引的？" id="title">28 ElasticSearch 是如何建立索引的？</h1>
<div><p>前面讲到了 NoSQL 数据库的应用，在关系型数据库和 NoSQL 数据库之外，还有一类非常重要的存储中间件，那就是<strong>文件索引</strong>。当你在电商网站搜索商品，或者在搜索引擎搜索资料时，都离不开基于文件索引的各种检索框架的支持。</p>
...
<h4 id="elasticsearch-应用">ElasticSearch 应用</h4>
<p>ElasticSearch 对搜索的支持非常好，但是和 NoSQL 数据库一样，对事务、一致性等的支持较低。</p>
<p>下面是一个实际开发中，常见的数据库-索引-缓存系统架构图：</p>
<p><img alt="25.png" src="assets/Ciqc1F7-68eAeYw2AAF83MZQ2m0681.png"/></p>
...
<p><img alt="3.png" src="assets/CgqCHl77Do-AXYgbAABfeRIU95w684.png"/></p>
<h4 id="对比-b-树">对比 B+ 树</h4>
