...
<h1 class="title" data-id="05 共识问题：区块链如何确认记账权？" id="title">05 共识问题：区块链如何确认记账权？</h1>
<div><p>本课时我们主要讲解“共识问题：区块链如何确认记账权？”</p>
...
<p><img alt="img" src="assets/Cgq2xl6VcOeALNa-AAGn4Gn2sTg985.png"/></p>
<p>（<a href="https://en.wikipedia.org/wiki/Byzantine_Empire" target="_blank">图片来自维基百科</a>）</p>
...
<img alt="img" src="assets/Ciqah16VcRuADpZ9AADBuF3YEmA082.png"/>
...
<h3 id="比特币的-pow-实现">比特币的 POW 实现</h3>
<p>比特币中的 POW 实现，是通过计算来猜测一个数值（Nonce），得以解决规定的 Hash 问题，下面是比特币的区块结构，可以看到区块头有个随机数字段，这个就是 Nonce 值：</p>
<p><img alt="img" src="assets/Ciqah16VcOeATZ5AAARuh8uNMzo929.png"/></p>
<p>中本聪在比特币系统中设置了一道题目，通过不断调节 Nonce 的值，来对区块头算 Hash，要求找到一个 Nonce 值，使得算出来的 Hash 值满足某个固定值。</p>
<p>具体的 Hash 方法一般是使用 SHA256 算法 ，你可以查看这个小工具来测试 <a href="https://tool.oschina.net/encrypt?type=2" target="_blank">https://tool.oschina.net/encrypt?type=2</a>。</p>
...
<p>作为落地的最大区块链系统，比特币的区块信息一直在动态生成。下面这张截图记录了比特币最近的区块信息，区块信息来自 <a href="https://www.blockchain.com/explorer" target="_blank">https://www.blockchain.com/</a>，你也可以点击链接查看最新的区块高度。</p>
...
<img alt="img" src="assets/CgoCgV6VcOeAChOOAADuXU78w9Q859.png"/></p>
