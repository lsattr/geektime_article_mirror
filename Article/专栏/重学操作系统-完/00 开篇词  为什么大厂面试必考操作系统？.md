...
<meta content="00 开篇词  为什么大厂面试必考操作系统？" name="description"/>
...
<h1 class="title" data-id="00 开篇词  为什么大厂面试必考操作系统？" id="title">00 开篇词  为什么大厂面试必考操作系统？</h1>
...
<h3 id="为什么要学习操作系统">为什么要学习操作系统？</h3>
...
<p><img alt="2.png" src="assets/CgqCHl9V0vKAQ5IbAAHTtF5p1Vc746.png"/></p>
...
<h3 id="为什么你要学习我这门操作系统课">为什么你要学习我这门操作系统课？</h3>
...
<p><img alt="3.png" src="assets/CgqCHl9V0ueAZF6MAAHXnXl0CKc462.png"/></p>
...
<li>程序语言（Java/Go/Node）的内存分配和回收；</li>
<li>数据库底层（MySQL/Hadoop）的文件系统；</li>
<li>计算机网络和操作系统 I/O 模型结合有哪些注意事项；</li>
<li>如何从操作系统底层理看容器化技术：K8s 和 Docker。</li>
</ul>
...
<p><img alt="1.png" src="assets/CgqCHl9V03aAEUTpAAHv8lYGeMI639.png"/></p>
