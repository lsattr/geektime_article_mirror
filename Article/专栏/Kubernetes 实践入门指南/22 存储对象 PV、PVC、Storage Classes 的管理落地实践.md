...
<meta content="22 存储对象 PV、PVC、Storage Classes 的管理落地实践" name="description"/>
...
<h1 class="title" data-id="22 存储对象 PV、PVC、Storage Classes 的管理落地实践" id="title">22 存储对象 PV、PVC、Storage Classes 的管理落地实践</h1>
...
<p><img alt="19-1-csi-arch" src="assets/c1e6bc40-2ce1-11eb-90f6-fbd19bda6e6e"/></p>
