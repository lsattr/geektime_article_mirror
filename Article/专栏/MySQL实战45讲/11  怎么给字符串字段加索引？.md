...
<p>图 1 email 索引结构</p>
<p><img alt="img" src="assets/134583875561de914991fc2e192cf842.jpg"/></p>
...
<p>你先来看看这个 SQL 语句：</p>
<pre><code>select id,email from SUser where email='<a class="__cf_email__" data-cfemail="b7cddfd6d9d0c4c4cfcecdf7cfcfcf99d4d8da" href="/cdn-cgi/l/email-protection">[email protected]</a>';
</code></pre>
<p>与前面例子中的 SQL 语句</p>
<pre><code>select id,name,email from SUser where email='<a class="__cf_email__" data-cfemail="ff85979e91988c8c878685bf878787d19c9092" href="/cdn-cgi/l/email-protection">[email protected]</a>';
</code></pre>
