...
<p>上面的镜像地址没有给出，默认使用docker hub下library用户下镜像，获取官方<code>library/ubuntu</code>仓库中标签为14.04的镜像。</p>
...
<p>如果在images列出的这中镜像既没有仓库名，也没有标签，并且均为”<code>&amp;lt;none&amp;gt;</code>“的镜像，比如</p>
...
<p>可以通过 <code>docker rmi --help</code> 查看更多帮助</p>
...
<p>在指令格式上，一般推荐使用exec格式，这类格式在解析时会被解析为JSON数组，<strong>因此一定要使用双引号”，而不要使用单引号</strong>。</p>
...
<p>效果如下所示：</p>
<p><img alt="" src="assets/2ef810bdc22540c3842f7b67816a7375.jpg"/></p>
...
<p><strong>根据容器状态列出容器</strong>（status）</p>
...
<p>使用-f参数还可以使用–format关键字，将获取到的内容格式化或者获取想要的指定的容器信息，</p>
