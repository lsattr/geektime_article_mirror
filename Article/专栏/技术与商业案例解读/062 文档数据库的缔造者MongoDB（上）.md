...
<meta content="062 文档数据库的缔造者MongoDB（上）" name="description"/>
<link href="/static/favicon.png" rel="icon"/>
<title>062 文档数据库的缔造者MongoDB（上） </title>
...
<h1 class="title" data-id="062 文档数据库的缔造者MongoDB（上）" id="title">062 文档数据库的缔造者MongoDB（上）</h1>
<div><p>大数据和云计算的风被谷歌吹起来的时候，被谷歌收购的网络广告公司DoubleClick的原CEO和CTO们觉得自己应该蹭上时代的列车，再次创业，然后10gen公司就这样在纽约诞生了。它的创始人分别是DoubleClick的创始人兼CTO德怀特 · 梅里曼（Dwight Merriman）、CEO凯文 · 瑞安（Kevin Ryan），以及工程师埃利特 · 霍洛威兹（Eliot Horowitz）。</p>
