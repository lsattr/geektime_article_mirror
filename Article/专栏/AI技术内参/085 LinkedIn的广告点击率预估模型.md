...
<meta content="085 LinkedIn的广告点击率预估模型" name="description"/>
<link href="/static/favicon.png" rel="icon"/>
<title>085 LinkedIn的广告点击率预估模型 </title>
...
<h1 class="title" data-id="085 LinkedIn的广告点击率预估模型" id="title">085 LinkedIn的广告点击率预估模型</h1>
<div><p>上一篇文章我们讲了雅虎的广告预估模型。雅虎早期的模型主要集中在如何利用两轮架构来对点击率进行精确建模，后期的模型回归到了比较传统的利用线性模型外加特性哈希来进行大规模点击率预估的模式。</p>
...
<h2 id="linkedin广告预估模型">LinkedIn广告预估模型</h2>
<p>我们首先来看一看LinkedIn的广告预估模型。这个模型的一大“卖点”就是直接充分考虑了“冷启动”和“热启动”两种模式。</p>
...
<h2 id="模型的其他特性">模型的其他特性</h2>
<p>这个模型在增加了这些系数的先验概率信息之后变得相对比较复杂。这篇论文介绍了一系列的模型训练思路，都是不错的可以借鉴的工业界经验。</p>
...
<h2 id="总结">总结</h2>
<p>今天我为你介绍了LinkedIn广告点击率预估的核心算法。一起来回顾下要点：第一，我们讲了LinkedIn把点击率预估分为三个部分，从而分别解决“冷启动”和“热启动”的思路；第二，我们聊了如何更加有效地对这个提出的模型进行训练学习。</p>
