...
<meta content="124 计算机视觉高级话题（一）：图像物体识别和分割" name="description"/>
...
<h1 class="title" data-id="124 计算机视觉高级话题（一）：图像物体识别和分割" id="title">124 计算机视觉高级话题（一）：图像物体识别和分割</h1>
<div><p>从今天开始，我们讨论几个相对比较高级的计算机视觉话题。这些话题都不是简单的分类或者回归任务，而是需要在一些现有的模型上进行改进。</p>
...
<h2 id="faster-r-cnn和mask-r-cnn">Faster R-CNN和Mask R-CNN</h2>
