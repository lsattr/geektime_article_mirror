...
<meta content="045 文档理解的重要特例：多模文档建模" name="description"/>
<link href="/static/favicon.png" rel="icon"/>
<title>045 文档理解的重要特例：多模文档建模 </title>
...
<h1 class="title" data-id="045 文档理解的重要特例：多模文档建模" id="title">045 文档理解的重要特例：多模文档建模</h1>
<div><p>本周我们重点分享搜索系统中的一个重要部件，那就是文档理解。周一我们首先分享了文档理解最基本的一个步骤，那就是给文档分类，主要是看不同文档表达什么类别的信息。然后，周三我们聊了聊另外一个重要的文档理解组件，也就是文档聚类的一些基本的概念和技术。今天我就来和你分享一个文档理解的重要特例：<strong>多模文档建模</strong>（Multimodal Modeling）。</p>
<h2 id="多模数据">多模数据</h2>
...
<h2 id="其他多模数据建模应用">其他多模数据建模应用</h2>
