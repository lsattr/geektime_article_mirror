...
<meta content="059 简单推荐模型之二：基于相似信息的推荐模型" name="description"/>
<link href="/static/favicon.png" rel="icon"/>
<title>059 简单推荐模型之二：基于相似信息的推荐模型 </title>
...
<h1 class="title" data-id="059 简单推荐模型之二：基于相似信息的推荐模型" id="title">059 简单推荐模型之二：基于相似信息的推荐模型</h1>
<div><p>这周我们开始讲推荐系统。周一的文章中，我们聊了一个最基本的推荐模型：基于流行度的推荐模型。这是一种简单且实用的推荐系统搭建方式，那就是需要对每一个物品的流行度进行估计。</p>
<p>今天，我们来看另外一种简单但很有效果的推荐模型：<strong>基于相似信息的推荐模型</strong>。</p>
<h2 id="什么是相似信息的推荐模型">什么是相似信息的推荐模型</h2>
...
<h2 id="基于相似用户的协同过滤">基于相似用户的协同过滤</h2>
...
<h2 id="基于相似物品的协同过滤">基于相似物品的协同过滤</h2>
