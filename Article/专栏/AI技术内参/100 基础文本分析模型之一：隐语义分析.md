...
<meta content="100 基础文本分析模型之一：隐语义分析" name="description"/>
<link href="/static/favicon.png" rel="icon"/>
<title>100 基础文本分析模型之一：隐语义分析 </title>
...
<h1 class="title" data-id="100 基础文本分析模型之一：隐语义分析" id="title">100 基础文本分析模型之一：隐语义分析</h1>
<div><p>本周我们分享了文本挖掘中的一个重要工具LDA（Latent Diriclet Allocation），这是一个出色的无监督学习的文本挖掘模型。</p>
...
<h2 id="隐语义分析的背景">隐语义分析的背景</h2>
<p>为什么需要隐语义分析呢？隐语义分析到底发挥了怎样的历史性作用呢？</p>
...
<h2 id="隐语义分析">隐语义分析</h2>
<p>对隐语义分析的一个简单直白的解释就是：<strong>利用矩阵分解的概念对“词-文档矩阵”（Term-Document Matrix）进行分解</strong>。</p>
