...
<meta content="21  执行引擎：分片环境下 SQL 执行的整体流程应该如何进行抽象？" name="description"/>
...
<h1 class="title" data-id="21  执行引擎：分片环境下 SQL 执行的整体流程应该如何进行抽象？" id="title">21  执行引擎：分片环境下 SQL 执行的整体流程应该如何进行抽象？</h1>
...
<p><img alt="Drawing 0.png" src="assets/CgqCHl9Dei6AMqoCAACpyMuj2MI683.png"/></p>
