...
<meta content="22  Kafka和RocketMQ的消息复制实现的差异点在哪？" name="description"/>
...
<h1 class="title" data-id="22  Kafka和RocketMQ的消息复制实现的差异点在哪？" id="title">22  Kafka和RocketMQ的消息复制实现的差异点在哪？</h1>
<div><p>你好，我是李玥。</p>
...
<h2 id="kafka-是如何实现复制的">Kafka 是如何实现复制的？</h2>
