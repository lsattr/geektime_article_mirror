...
<p><img alt="img" src="assets/2020-05-05-021608.jpg"/></p>
...
<p>这种方案还需要编写数据更新操作方法，如果这些代码都不想写，有没有什么好办法？当然有，总会有”懒”程序员帮你省事，介绍一个组件 <a href="https://github.com/lukas-krecan/ShedLock" target="_blank">ShedLock</a>，可以使我们的定时任务在同一时刻，最多执行一次。</p>
