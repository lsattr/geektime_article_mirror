...
<meta content="10 集合类：坑满地的List列表操作" name="description"/>
<link href="/static/favicon.png" rel="icon"/>
<title>10 集合类：坑满地的List列表操作 </title>
...
<h1 class="title" data-id="10 集合类：坑满地的List列表操作" id="title">10 集合类：坑满地的List列表操作</h1>
<div><p>今天，我来和你说说 List 列表操作有哪些坑。</p>
...
<h2 id="使用-arrays-aslist-把数据转换为-list-的三个坑">使用 Arrays.asList 把数据转换为 List 的三个坑</h2>
...
<pre><code class="language-log">12:50:39.445 [main] INFO org.geekbang.time.commonmistakes.collection.aslist.AsListApplication - list:[[I@1c53fd30] size:1 class:class [I
</code></pre>
...
<pre><code class="language-log">public static &lt;T&gt; List&lt;T&gt; asList(T... a) {
...
<pre><code class="language-log">13:10:57.373 [main] INFO org.geekbang.time.commonmistakes.collection.aslist.AsListApplication - list:[1, 2, 3] size:3 class:class java.lang.Integer
</code></pre>
...
<pre><code class="language-java">String[] arr = {"1", "2", "3"};
List list = Arrays.asList(arr);
arr[1] = "4";
try {
    list.add("5");
...
<pre><code class="language-log">java.lang.UnsupportedOperationException
...
<pre><code class="language-log">13:34:50.829 [main] INFO org.geekbang.time.commonmistakes.collection.aslist.AsListApplication - arr:[1, 4, 3] list:[1, 2, 3, 5]
</code></pre>
<h2 id="使用-list-sublist-进行切片操作居然会导致-oom">使用 List.subList 进行切片操作居然会导致 OOM？</h2>
...
<pre><code class="language-java">private static List&lt;List&lt;Integer&gt;&gt; data = new ArrayList&lt;&gt;();
...
<pre><code class="language-log">Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
...
<pre><code class="language-java">List&lt;Integer&gt; list = IntStream.rangeClosed(1, 10).boxed().collect(Collectors.toList());
...
<p>代码运行后得到如下输出：</p>
<pre><code class="language-java">[2, 3, 4]
[1, 2, 4, 5, 6, 7, 8, 9, 10]
...
<h2 id="一定要让合适的数据结构做合适的事情">一定要让合适的数据结构做合适的事情</h2>
...
<pre><code class="language-java">private static Object listSearch(int elementCount, int loopCount) {
...
<pre><code class="language-java">private static Object mapSearch(int elementCount, int loopCount) {
...
<pre><code class="language-java">int elementCount = 1000000;
...
20861992
72388672</p>
<h2 id="stopwatch-running-time-3506699764-ns">StopWatch “: running time = 3506699764 ns</h2>
<h2 id="ns-task-name">ns         %     Task name</h2>
<p>3398413176  097%  listSearch
108286588  003%  mapSearch</p>
<pre><code>
...
<pre><code class="language-java">int elementCount = 100000;
...
<p><img alt="img" src="assets/122a469eb03f16ab61d893ec57b34acc.png"/></p>
...
<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'8f0ac60039cc0980',t:'MTczMzk3NTY2OS4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
