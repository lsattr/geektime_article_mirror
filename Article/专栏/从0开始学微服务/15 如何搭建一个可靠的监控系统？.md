...
<meta content="15 如何搭建一个可靠的监控系统？" name="description"/>
...
<h1 class="title" data-id="15 如何搭建一个可靠的监控系统？" id="title">15 如何搭建一个可靠的监控系统？</h1>
...
<p><img alt="" src="assets/cd8d76c0ab3a17bf16c19f973e92bb9a.png">-
（图片来源：<a href="https://cdn-images-1.medium.com/max/1600/1*mwSvtVy_qGz0nTjaYbvwpw.png" target="_blank">https://cdn-images-1.medium.com/max/1600/1*mwSvtVy_qGz0nTjaYbvwpw.png</a>）</img></p>
<p>这三个软件的功能也各不相同。</p>
<ul>
...
<p><img alt="" src="assets/e6ebce07db63a7f0d6e4c03cb458eaef.png"/>-
...
<p><img alt="" src="assets/fc78b78efe3c2cb52f478e61a9ebbc11.png"/>-
...
<p><img alt="" src="assets/6e5c85e68f0eff409f70f17f846d5335.png"/>-
...
<p><img alt="" src="assets/a42d15cb006b41fecc82575b566dbc71.png"/>-
...
<p>alias(sumSeries(stats.openapi.profile.*.API._comments_flow.total_count,“Total QPS”)</p></li>
<li><p>InfluxDB通过类似SQL语言的InfluxQL，能对监控数据进行复杂操作，比如查询一分钟CPU的使用率，用InfluxDB实现的示例是：</p>
<p>SELECT 100 - usage_idel FROM “autogen”.“cpu” WHERE time &gt; now() - 1m and “cpu”=‘cpu0’</p></li>
<li><p>Prometheus通过私有的PromQL查询语言，如果要和上面InfluxDB实现同样的功能，PromQL语句如下，看起来更加简洁。</p>
<p>100 - (node_cpu{job=“node”,mode=“idle”}[1m])</p></li>
</ul>
