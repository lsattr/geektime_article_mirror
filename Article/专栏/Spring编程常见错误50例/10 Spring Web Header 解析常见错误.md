...
<meta content="10 Spring Web Header 解析常见错误" name="description"/>
<link href="/static/favicon.png" rel="icon"/>
<title>10 Spring Web Header 解析常见错误 </title>
...
<li>
<a class="menu-item" href="/%e4%b8%93%e6%a0%8f/Spring%e7%bc%96%e7%a8%8b%e5%b8%b8%e8%a7%81%e9%94%99%e8%af%af50%e4%be%8b/04%20Spring%20Bean%20%e7%94%9f%e5%91%bd%e5%91%a8%e6%9c%9f%e5%b8%b8%e8%a7%81%e9%94%99%e8%af%af.md" id="04 Spring Bean 生命周期常见错误.md">04 Spring Bean 生命周期常见错误.md</a>
</li>
<li>
...
<li>
<a class="menu-item" href="/%e4%b8%93%e6%a0%8f/Spring%e7%bc%96%e7%a8%8b%e5%b8%b8%e8%a7%81%e9%94%99%e8%af%af50%e4%be%8b/16%20Spring%20Exception%20%e5%b8%b8%e8%a7%81%e9%94%99%e8%af%af.md" id="16 Spring Exception 常见错误.md">16 Spring Exception 常见错误.md</a>
</li>
<li>
...
<h1 class="title" data-id="10 Spring Web Header 解析常见错误" id="title">10 Spring Web Header 解析常见错误</h1>
...
<p><img alt="" src="assets/0cbf5aa76e434cac8a00a95cfc52fe17.jpg"/></p>
...
<pre><code>public MessageBytes getValue(String name) {
...
<pre><code>protected Object resolveName(String name, MethodParameter parameter, NativeWebRequest request) throws Exception {
...
<pre><code>@RequestMapping(path = "/hi3", method = RequestMethod.GET)
...
<pre><code>private void addHeader(String name, String value, Charset charset) {
    //省略其他非关键代码
...
<pre><code>private boolean checkSpecialHeader(String name, String value) {
...
<p><img alt="" src="assets/e24f8fde8cdd4dd08be4fc3f337c74d2.jpg"/></p>
...
<pre><code>for (HttpMessageConverter&lt;?&gt; converter : this.messageConverters) {
...
<p><img alt="" src="assets/4730528ead9b4c92a29dfa3ef10bb648.jpg"/></p>
...
<pre><code>protected void addDefaultHeaders(HttpHeaders headers, T t, @Nullable MediaType contentType) throws IOException {
...
<p>参考代码如下：</p>
<pre><code>GET http://localhost:8080/hi3
...
<p>主动显式指明类型，修改方法如下：</p>
<pre><code>@RequestMapping(path = "/hi3", method = RequestMethod.GET, produces = {"application/json"})
</code></pre>
...
<pre><code>protected List&lt;MediaType&gt; getProducibleMediaTypes(
...
<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'8f0bcdc83f0d8554',t:'MTczMzk4NjQ3NC4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
