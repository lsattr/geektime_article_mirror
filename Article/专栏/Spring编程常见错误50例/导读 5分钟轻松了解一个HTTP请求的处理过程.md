...
<meta content="导读 5分钟轻松了解一个HTTP请求的处理过程" name="description"/>
<link href="/static/favicon.png" rel="icon"/>
<title>导读 5分钟轻松了解一个HTTP请求的处理过程 </title>
...
<h1 class="title" data-id="导读 5分钟轻松了解一个HTTP请求的处理过程" id="title">导读 5分钟轻松了解一个HTTP请求的处理过程</h1>
<div><p>你好，我是傅健。</p>
...
<pre><code>public class HttpRequestHandler{
...
<p><img alt="" src="assets/87f83fe678694b96afb78d62b461ba25.jpg"/></p>
...
<p><img alt="" src="assets/4b8b3a9eec9046149c4f6c8481a99de6.jpg"/></p>
<p>说白了，就是调用下述代码行就会启动Tomcat：</p>
<pre><code>SpringApplication.run(Application.class, args);
</code></pre>
<p>那为什么使用的是Tomcat？你可以看下面这个类，或许就明白了：</p>
<pre><code>//org.springframework.boot.autoconfigure.web.servlet.ServletWebServerFactoryConfiguration
...
<pre><code>   @ConditionalOnClass({ Servlet.class, Tomcat.class, UpgradeProtocol.class })
</code></pre>
...
<p><img alt="" src="assets/88c01a6e7cfb404a8ab742b37559406c.jpg"/></p>
<p>线程池对这个请求的处理的调用栈如下：</p>
<p><img alt="" src="assets/27da4f2b056b4c709656e95e0d37c27e.jpg"/></p>
...
<p><img alt="" src="assets/107d4853543d466599f484fc26a98d4e.jpg"/></p>
...
<p><img alt="" src="assets/70da4564e8b44f1682472b6d8a1a304c.jpg"/></p>
...
<p><img alt="" src="assets/ec78729486f54bdea3735437ad3f59ea.jpg"/></p>
