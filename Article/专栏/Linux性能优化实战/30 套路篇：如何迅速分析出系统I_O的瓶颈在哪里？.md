...
<h1 class="title" data-id="30 套路篇：如何迅速分析出系统I_O的瓶颈在哪里？" id="title">30 套路篇：如何迅速分析出系统I_O的瓶颈在哪里？</h1>
<div><p>你好，我是倪朋飞。</p>
...
<p><img alt="" src="assets/008f1cb04a5446f4a784be520f8847c1.jpg"/></p>
<p>学了这么久的 I/O 性能知识，一说起 I/O 指标，你应该首先会想到分类描述。我们要区分开文件系统和磁盘，分别用不同指标来描述它们的性能。</p>
<h3 id="文件系统i-o性能指标">文件系统I/O性能指标</h3>
<p>我们先来看文件系统的情况。</p>
...
<h3 id="磁盘i-o性能指标">磁盘I/O性能指标</h3>
<p>接下来，我们就来具体看看，哪些性能指标可以衡量磁盘 I/O 的性能。</p>
<p>在磁盘 I/O 原理的文章中，我曾提到过四个核心的磁盘 I/O 指标。</p>
<ul>
<li><p><strong>使用率</strong>，是指磁盘忙处理I/O请求的百分比。过高的使用率（比如超过60%）通常意味着磁盘I/O存在性能瓶颈。</p></li>
<li><p><strong>IOPS</strong>（Input/Output Per Second），是指每秒的 I/O 请求数。</p></li>
<li><p><strong>吞吐量</strong>，是指每秒的 I/O 请求大小。</p></li>
<li><p><strong>响应时间</strong>，是指从发出 I/O 请求到收到响应的间隔时间。</p></li>
</ul>
<p>考察这些指标时，一定要注意综合 I/O 的具体场景来分析，比如读写类型（顺序还是随机）、读写比例、读写大小、存储类型（有无RAID以及RAID级别、本地存储还是网络存储）等。</p>
...
<p><img alt="" src="assets/557f561bdd7f4c448a268678206954a0.jpg"/></p>
<p>下面，我们再来看第二个维度。</p>
...
<p><img alt="" src="assets/55df78a29c0d44dba8c6fdf59e292f33.jpg"/></p>
