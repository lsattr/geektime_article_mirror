...
<meta content="18  金融级高可用架构：必不可少的数据核对" name="description"/>
...
<h1 class="title" data-id="18  金融级高可用架构：必不可少的数据核对" id="title">18  金融级高可用架构：必不可少的数据核对</h1>
...
<p>我们来看这样一张图：</p>
<p><img alt="1.png" src="assets/CioPOWDTCOaAVe7oAADUFFKmNU4530.png"/></p>
<p>从图中可以看到，即使启用无损半同步复制，依然存在当发生主机宕机时，最后一组事务没有上传到从机的可能。图中宕机的主机已经提交事务到 101，但是从机只接收到事务 100。如果这个时候 Failover，从机提升为主机，那么这时：</p>
<p><img alt="2.png" src="assets/Cgp9HWDTCPCAC922AADW2MxBbwQ555.png"/></p>
...
<p><img alt="3.png" src="assets/Cgp9HWDTCPmAbsNEAAD2UJugkKg920.png"/></p>
...
<p><img alt="4.png" src="assets/CioPOWDTCQGADPvMAAEmUGR02eM950.png"/></p>
...
<p><img alt="5.png" src="assets/Cgp9HWDTCQyAFtFCAAF7qJpeUuM426.png"/></p>
...
<p><img alt="6.png" src="assets/CioPOWDTCROAOWeTAAF4gz8w6PY448.png"/></p>
...
<p><img alt="7.png" src="assets/CioPOWDTCR2AcmV6AAC1N5tCM7E109.png"/></p>
