...
<p><img alt="在这里插入图片描述" src="assets/20210127144807275.png"/></p>
<p>好像上图所示，比如一次性发送4个作为一个window。收到了两个，可以ack两个，然后起点再发两个，始终保持一个窗口有四个Frame在发送中。这个算法我们后面还会用到，而且面试中也会考Sliding Window的算法题（感兴趣的同学自己试一下）。</p>
...
<p><img alt="在这里插入图片描述" src="assets/20210127145045844.png"/></p>
...
<p><img alt="在这里插入图片描述" src="assets/20210127145204541.png"/></p>
...
<p><img alt="在这里插入图片描述" src="assets/20210127145220561.png"/></p>
...
<p>HDLC（High-level Data Link Control)定义了三种类型的Frame。每一种Frame都有自己独有的控制位标识。</p>
<ul>
...
<p><img alt="在这里插入图片描述" src="assets/20210127145243705.png"/></p>
