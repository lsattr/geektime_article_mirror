...
<h2 id="java-开发中的常见问题">Java 开发中的常见问题</h2>
...
<h3 id="1-不要重复造轮子-也不要搬太多不同型号的轮子来用">1 不要重复造轮子，也不要搬太多不同型号的轮子来用</h3>
...
<h3 id="2-深入了解依赖注入-选择一个好框架">2 深入了解依赖注入，选择一个好框架</h3>
...
<h3 id="3-所有项目使用统一的文件夹结构">3 所有项目使用统一的文件夹结构</h3>
