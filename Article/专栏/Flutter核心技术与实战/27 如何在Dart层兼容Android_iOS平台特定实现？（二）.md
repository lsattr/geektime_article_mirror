...
<p><img alt="" src="assets/38cf2fbb91584a4799815e41e3b11fd3.jpg"/></p>
<p>图1 四象限分析法</p>
...
<p><img alt="" src="assets/ab585fd02fdc419f815f310ee1a540a6.jpg"/></p>
<p>图2 平台视图示例</p>
...
<p>如下所示，我们分别在iOS和Android平台的Flutter应用上，内嵌了一个红色的原生视图：</p>
<p><img alt="" src="assets/89abfd6ac28a4d9f9df94e5c629bd500.jpg"/></p>
<p>图3 内嵌原生视图示例</p>
...
<p>由于我们在底层直接持有了原生视图的实例，因此理论上可以直接在这个原生视图的Flutter封装类上提供视图修改方法，而不管它到底是StatelessWidget还是StatefulWidget。但为了遵照Flutter的Widget设计理念，我们还是决定将视图展示与视图控制分离，即：将原生视图封装为一个StatefulWidget专门用于展示，通过其controller初始化参数，在运行期修改原生视图的展示效果。如下所示：</p>
<pre><code>//原生视图控制器
...
<p>运行一下，效果如下所示：</p>
<p><img alt="" src="assets/7dffd34126e04771a82ef98521f22f9b.jpg"/></p>
<p>图4 动态修改原生视图样式</p>
<h2 id="总结">总结</h2>
