...
<meta content="025 案例  层次的职责与协作关系（图文篇）" name="description"/>
<link href="/static/favicon.png" rel="icon"/>
<title>025 案例  层次的职责与协作关系（图文篇） </title>
...
<h1 class="title" data-id="025 案例  层次的职责与协作关系（图文篇）" id="title">025 案例  层次的职责与协作关系（图文篇）</h1>
<div><p>经历多次演进，我们已经初步得到了符合领域驱动设计思想的分层架构，但这种架构仅仅是一种静态的逻辑划分，在实现一个业务用例时，各层之间是怎么协作的，我们似乎还不得而知。辨别这种动态的协作关系，还是应该从职责的角度入手，即必须清楚地理解分层架构中每个逻辑层的职责。</p>
...
<p><img alt="enter image description here" src="assets/42e90700-c0bd-11e8-afc9-4db08e1ecfa6"/></p>
...
<p><strong>注意</strong>：这里定义了两个分属不同层次的服务，二者极容易混淆。PlaceOrderService 是领域服务，定义在领域层中；OrderAppService 是应用服务，定义在应用层中。这二者的区别属于战术设计的层面，我会在之后的战术设计讲解中深入阐释，我的博客《<a href="http://zhangyi.xyz/how-to-identify-application-service/" target="_blank">如何分辨应用服务与领域服务</a>》也有比较详细的介绍。</p>
