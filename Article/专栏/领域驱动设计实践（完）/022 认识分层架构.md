...
<meta content="022 认识分层架构" name="description"/>
<link href="/static/favicon.png" rel="icon"/>
<title>022 认识分层架构 </title>
...
<h1 class="title" data-id="022 认识分层架构" id="title">022 认识分层架构</h1>
<div><p>分层架构是运用最为广泛的架构模式，几乎每个软件系统都需要通过层（Layer）来隔离不同的关注点（Concern Point），以此应对不同需求的变化，使得这种变化可以独立进行；此外，分层架构模式还是隔离业务复杂度与技术复杂度的利器，《领域驱动设计模式、原理与实践》这样写道：</p>
<blockquote>
...
<p><img alt="img" src="assets/da59ee30-acf2-11e8-9c45-adc0fa12a28f"/></p>
<h4 id="领域驱动设计的经典分层架构">领域驱动设计的经典分层架构</h4>
...
<p><img alt="enter image description here" src="assets/f942d550-acf2-11e8-afe5-6ba901a27e1b"/></p>
<p>该书对各层的职责作了简单的描述：</p>
<table>
<thead>
<tr>
...
<p><img alt="enter image description here" src="assets/19351620-acf3-11e8-afe5-6ba901a27e1b"/></p>
<h4 id="层与层之间的协作">层与层之间的协作</h4>
