...
<meta content="034 实践  确定限界上下文的协作关系" name="description"/>
<link href="/static/favicon.png" rel="icon"/>
<title>034 实践  确定限界上下文的协作关系 </title>
...
<h1 class="title" data-id="034 实践  确定限界上下文的协作关系" id="title">034 实践  确定限界上下文的协作关系</h1>
<div><p>通过上下文映射来确定限界上下文之间的协作关系，是识别限界上下文之后至为关键的一步。每个限界上下文都仅仅展示了整体架构全局视图的一角，只有将它们联合起来，才能产生合力，满足业务场景的需要。若这种协作关系处理不当，这种联合的合力反倒成了一种阻力，清晰的架构不见，限界上下文带给我们的“价值”就会因此荡然无存。</p>
...
<h3 id="识别-eas-的上下文映射">识别 EAS 的上下文映射</h3>
...
<h4 id="根据用例识别协作关系">根据用例识别协作关系</h4>
...
<p><img alt="enter image description here" src="assets/156bb3b0-d3a3-11e8-a9a3-fd92848cdb84"/></p>
...
<p><img alt="img" src="assets/24b48360-d3a3-11e8-83c4-93b72872a9ed"/></p>
...
<p><img alt="img" src="assets/39e7e970-d3a3-11e8-83c4-93b72872a9ed"/></p>
...
<p><img alt="img" src="assets/4ddae040-d3a3-11e8-b055-6fdf72668cfc"/></p>
<p>“创建市场需求”用例图如下所示：</p>
<p><img alt="enter image description here" src="assets/5fd625c0-d3a3-11e8-abac-396c1f0bcec5"/></p>
...
<p><img alt="img" src="assets/71be3160-d3a3-11e8-b055-6fdf72668cfc"/></p>
<p>有些限界上下文之间的关系是隐含的，需要透过用例去理解内在的业务流程才能探明这种关系。例如，“制定招聘计划”用例：</p>
<p><img alt="enter image description here" src="assets/8143bbf0-d3a3-11e8-83c4-93b72872a9ed"/></p>
...
<p><img alt="img" src="assets/93465470-d3a3-11e8-83c4-93b72872a9ed"/></p>
<p>通过识别上下文映射，还会帮助我们<strong>甄别一些错误的限界上下文职责边界划定</strong>。例如，针对“添加项目成员”用例：</p>
<p><img alt="enter image description here" src="assets/a5a60110-d3a3-11e8-b055-6fdf72668cfc"/></p>
...
<p><img alt="img" src="assets/b74bac80-d3a3-11e8-abac-396c1f0bcec5"/></p>
...
<p><img alt="img" src="assets/c59052a0-d3a3-11e8-abac-396c1f0bcec5"/></p>
...
<p><img alt="enter image description here" src="assets/edd10a70-d3a3-11e8-abac-396c1f0bcec5"/></p>
...
<p><img alt="img" src="assets/fdaf1540-d3a3-11e8-abac-396c1f0bcec5"/></p>
<h4 id="定义协作接口">定义协作接口</h4>
...
<p><img alt="img" src="assets/106d0e80-d3a4-11e8-83c4-93b72872a9ed"/></p>
<p>记录与<strong>订单上下文</strong>相关的协作接口如下表所示：</p>
<p><img alt="enter image description here" src="assets/fd0d7030-d797-11e8-a846-1515ba7379c6"/></p>
