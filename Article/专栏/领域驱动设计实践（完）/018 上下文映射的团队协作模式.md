...
<meta content="018 上下文映射的团队协作模式" name="description"/>
<link href="/static/favicon.png" rel="icon"/>
<title>018 上下文映射的团队协作模式 </title>
...
<h1 class="title" data-id="018 上下文映射的团队协作模式" id="title">018 上下文映射的团队协作模式</h1>
<div><p>如果我们将限界上下文理解为是对工作边界的控制，则上下文之间的协作实则就是团队之间的协作，高效的团队协作应遵循“各司其职、权责分明”的原则。从组织层面看，需要预防一个团队的“权力膨胀”，导致团队的“势力范围”扩大到整个组织；从团队层面，又需要避免自己的权力遭遇压缩，导致自己的话语权越来越小，这中间就存在一个平衡问题。映射到领域驱动设计的术语，就是要<strong>在满足合理分配职责的前提下，谨慎地确保每个限界上下文的粒度</strong>。</p>
...
<h3 id="合作关系-partnership">合作关系（Partnership）</h3>
...
<p><img alt="enter image description here" src="assets/4d13b140-ab36-11e8-bd17-d5905bbd0c49"/></p>
...
<p><img alt="enter image description here" src="assets/5d46e0f0-ab36-11e8-bdd5-d99c499845ac"/></p>
...
<h3 id="共享内核-shared-kernel">共享内核（Shared Kernel）</h3>
...
<h3 id="客户方-供应方开发-customer-supplier-development">客户方-供应方开发（Customer-Supplier Development）</h3>
...
<h3 id="遵奉者-conformist">遵奉者（Conformist）</h3>
...
<h3 id="分离方式-separate-ways">分离方式（Separate Ways）</h3>
...
<p><img alt="enter image description here" src="assets/7b519d10-ab36-11e8-8793-2b2eb0e28f96"/></p>
