...
<meta content="08 正则表达式：如何提高搜索内容的精确度？" name="description"/>
...
<h1 class="title" data-id="08 正则表达式：如何提高搜索内容的精确度？" id="title">08 正则表达式：如何提高搜索内容的精确度？</h1>
<div><p>你好，我是尹会生。</p>
...
<p><img alt="" src="assets/5062551c283445099522554b98be103a.jpg"/></p>
...
<p>上面代码匹配出的结果是”aaa13”。</p>
<p>这里需要提醒你注意，如果你想匹配的字符串只包含5个字符，那就需要增加匹配的限定条件的元字符“＾”和“<span class="math inline">\(”。**“＾”表示从第1个字符开始匹配。“\)</span>”表示从结尾开始匹配。**所以你需要将正则表达式”…..“改为”＾…..$“形式，才能实现只匹配5个字符的模式。</p>
