...
<h4 id="面向-js-的压缩工具">面向 JS 的压缩工具</h4>
...
<h3 id="以提升后续环节工作效率为目标的方案">以提升后续环节工作效率为目标的方案</h3>
<p>优化阶段的另一类优化方向是通过对本环节的处理减少后续环节处理内容，以便提升后续环节的工作效率。我们列举两个案例：Split Chunks（分包） 和 Tree Shaking（摇树）。</p>
<h4 id="split-chunks">Split Chunks</h4>
<p><a href="https://webpack.js.org/guides/code-splitting/" target="_blank">Split Chunks（分包）</a>是指在 Chunk 生成之后，将原先以入口点来划分的 Chunks 根据一定的规则（例如异步引入或分离公共依赖等原则），分离出子 Chunk 的过程。</p>
...
<p><img alt="Drawing 3.png" src="assets/Ciqc1F9kWAWANNLZAAGM4v1icLA197.png"/>
<img alt="Drawing 4.png" src="assets/CgqCHl9kWAqAELXZAAG5xisRryc225.png"/></p>
